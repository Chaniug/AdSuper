...
如果你想直接使用 AdSuper 规则，将以下链接添加到你的广告拦截器（uBlock Origin / AdGuard / AdBlock 等）：
...
❌ **不好的例子**（规则夹在文字中，虽然也能识别但不推荐）：
```
Issue 标题: 新规则
Issue 内容: 我发现这些规则 ||ads1.com^ 和 ||ads2.com^ 都要拦截
```
